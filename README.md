        ...
        const pages = {
            ...
            gallery: {
                ...
                render: () => `
                    ...
                    <p class="page-subtitle">Наши пушистые друзья</p>
                    <div class="gallery-grid">
                        <div class="card">
                            <img src="images/cat1.jpg" alt="Фото 1" loading="lazy">
                            <p>1</p>
                        </div>
                        <div class="card">
                            <img src="images/cat2.jpg" alt="Фото 2" loading="lazy">
                            <p>2</p>
                        </div>
                        <div class="card">
                            <img src="images/cat3.jpg" alt="Фото 3" loading="lazy">
                            <p>3</p>
                        </div>
                        <div class="card">
                            <img src="images/cat4.jpg" alt="Фото 4" loading="lazy">
                            <p>4</p>
                        </div>
                        <div class="card">
                            <img src="images/cat5.jpg" alt="Фото 5" loading="lazy">
                            <p>5</p>
                        </div>
                        <div class="card">
                            <img src="images/cat6.jpg" alt="Фото 6" loading="lazy">
                            <p>6</p>
                        </div>
                        <div class="card">
                            <img src="images/cat7.jpg" alt="Фото 7" loading="lazy">
                            <p>7</p>
                        </div>
                        <div class="card">
                            <img src="images/cat8.jpg" alt="Фото 8" loading="lazy">
                            <p>8</p>
                        </div>
                    </div>
                `
